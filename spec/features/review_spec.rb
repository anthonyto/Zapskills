...
RSpec.feature "Search: ", :type => :feature do
  ...
  scenario "add and check for review(Around me checked and user having same skill)" do
  ...
  scenario "search for the skill and write a review, reviewee cannot edit (Around me unchecked and user having the same skill)" do
    expect(page).to have_content "Camping"
    expect(page).to have_content "Great job"
  ...
  scenario "search for the skill and write a review and a 3rd user cannot edit (Around me unchecked and user having the same skill)" do
    expect(page).to have_content "Camping"
    expect(page).to have_content "Great job"
    page.should have_selector('table tr', :count => 4)
    expect(page).to have_content "Profile"
